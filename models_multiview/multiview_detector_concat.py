...
from detection.Multi_roi_heads import Multi_roi_heads, Multi_concat_roi_heads
...
def create_model(num_classes, size= (1400, 1700), norm= None, pretrained=True, coco_model=False, loss_type ='fasterrcnn1', **kwargs):
    ...
    if box_head is None:
        ...
        box_head = TwoMLPHead(2*out_channels * resolution**2, representation_size)

    if box_predictor is None:
        representation_size = 1024
        box_predictor = FastRCNNPredictor(representation_size, num_classes)
    model.roi_heads = Multi_concat_roi_heads(
            box_roi_pool,
            box_head,
            box_predictor,
            box_fg_iou_thresh,
